        ...
        {showform1 ? (
          <View style={styles.conatiner}>
            <View style={styles.basicinfobox}>
              ...
              <ProgressBar
                style={{height: 9, borderRadius: 7, width: '90%'}}
                progress={0.5}
                color={'#fff'}
              />
            </View>
            <View style={{paddingVertical: 20}}>
              <View style={{display: 'flex', flexDirection: 'row'}}>
                ...
                <View style={{display: 'flex', flexDirection: 'column'}}>
                  ...
                  <Text
                    style={{color: '#000', fontWeight: 'normal', fontSize: 13}}>
            ...
            <TouchableOpacity
              onPress={() => setShowform1((showform) => !showform)}
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                height: 50,
                backgroundColor: '#8AB748',
                borderRadius: 25,
                marginBottom: 20,
              }}>
          ...
          <View style={styles.conatiner}>
            ...
            <View
              ...
              <Text
                style={{fontSize: 16, color: '#79AB42', textAlign: 'center'}}>
                Skip
              </Text>
            </View>
          </View>
