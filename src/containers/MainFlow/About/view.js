      ...
      <ScrollView style={{backgroundColor: 'white'}}>
        ...
        <View
          ...
          <View
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <Text style={{fontSize: 15, color: '#71BC40'}}>years old</Text>
            </View>
            <View
              style={{
                display: 'flex',
              ...
              <Text style={{color: '#71BC40'}}>{'  ' + user.height}</Text>
            </View>
          </View>
          <View
            style={{
            ...
            <View
              ...
              <Text style={{color: '#71BC40'}}>{'  ' + user.kicker}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.videobox}>
          ...
          <View
            ...
            <WebView
              source={{
                html:
                  user.videourl.split('watch?v=')[1] === undefined
        ...
        <View style={styles.videobox}>
          ...
          <Text style={styles.overviewinfo}>
            ...
            with the release of Letterset sheets containing Lorem Ipsum
            passages, and more recently with desktop publishing software like
            Aldus PageMaker including versions of Lorem Ipsum.publishing
          </Text>
        </View>
        <View style={{height: 27}}></View>
        {/* <View style={styles.videoboxes}>
          ...
          <View style={styles.footballbox}>
            <View
              ...
              <Text style={{color: '#79AB42', fontSize: 22, marginRight: 20}}>
                Football
              </Text>
              <TouchableOpacity
                style={styles.iconbox}
            ...
            {user?.skills.map((skill) => (
              <>
                <View
                  ...
                  <Text style={{color: '#79AB42', fontSize: 17}}>
                    {skill.name}
                  </Text>
          ...
          {user?.experience.map((exp) => (
            <>
              <View
                ...
                <Avatar.Image
                  size={80}
                  source={require('../../../assets/images/burnley-logo-3.png')}
...
const styles = StyleSheet.create({
  ...
  usertype: {fontWeight: '500', marginTop: 1, fontSize: 17, color: '#635F5F'},
  overviewinfo: {
    fontWeight: '600',
    fontSize: 15,
    marginTop: 15,
