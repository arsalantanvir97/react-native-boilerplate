...
const RecordingDoneView: () => React$Node = (props) => {
...
const endingHandler=()=>{
  ...
  return (
    <>
      ...
      <Text style={{fontSize:16,fontWeight:'bold',textAlign:'center'}}>RECORDING DONE </Text>
      <Text style={{fontSize:13,fontWeight:'normal',textAlign:'center',marginTop:6}}>looks good </Text>
      ...
      {/* <CustomSurface style={styles.cardContainer}> */}
        {/* <View> */}
          ...
          <VideoPlayer source={{uri: "https://res.cloudinary.com/n4beel/video/upload/v1623929802/Y2Mate.is_-_10_Impossible_Goals_Scored_By_Lionel_Messi_That_Cristiano_Ronaldo_Will_Never_Ever_Score_HD-5twveLmWhvI-480p-1623687430417_fnppoj.mp4"}}   // Can be a URL or a local file.
...
<Text style={{fontSize:13,}}>01:00</Text></View>
<View style={{height:90}}></View>
<View style={{display:'flex',alignItems:'center',flexDirection:'column'}}> 
<Button style={{display:'flex',alignItems:'center',justifyContent:'center',marginBottom:20,width:250,height:50,borderRadius:25,backgroundColor:'#79AB42',color:'#fff'}} >
      <Text style={{color:'#fff',fontSize:12}}>Send for Analysis</Text> 
      </Button>
      <Text style={{color:'#79AB42',fontSize:15}}>Discard</Text> 
...
export default RecordingDoneView;