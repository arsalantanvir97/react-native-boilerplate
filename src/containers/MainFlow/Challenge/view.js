...
const ChallengeView: () => React$Node = (props) => {
  ...
  const [data2, setData2] = useState([
    {
      ...
      date: '20/21/2020',
      connections: 40,
      avatar: require('../../../assets/images/xhaka.jpg'),
      player: 'Granit Xhaka',
    },
    {
      id: '2',
    ...
    // { id: '3', image: IMAGES.image3,name:'abcde' },
    {
      ...
      date: '20/21/2020',
      connections: 44,
      avatar: require('../../../assets/images/messi.jpeg'),
      player: 'Leo Messi',
    },
    {
      id: '5',
  ...
  const setToggleboxes = (index) => {
    if (!toggleboxnumber.includes(index)) {
      ...
      setToggleboxnumber(toggleboxnumber.filter((xd) => xd !== index));
      setTogglebox(!togglebox);
    }
  };
